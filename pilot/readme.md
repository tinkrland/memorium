...
each compute objective is mapped to the memorium pillar it stress-tests in [../research/brainstorm/substrate-pillar-mapping.md](../research/brainstorm/substrate-pillar-mapping.md) — draft, on the brainstorm branch. the short version: the pilot has effectively been running agenda experiments 2, 3, and 4 for days (strength calibration, grid placement, thread bootstrap-survival), objective 5's reinforcement-decay is axis 5's priority model, objective 6's load-bearing index could make memorium's identity-core weights *derived* instead of hand-assigned, and objective 7's validity metric is the "contact check" pillar 7 is currently missing. the one pillar the pilot can't touch is 6 — sandboxed perspectives need personas, and substrate has none.
